 ...
 */
public class HURI extends HResource implements URI { //}, HResourceI {
  ...
  public boolean equals(Object o) {
    ...
    if (!localName.equals(huri.getLocalName())) return false;
    if (!namespace.equals(huri.getNamespace())) return false;
